...
When(
  'the card is edited to title {string}',
...
Given(
  'a Jira-sourced card titled {string} exists in storage',
  async function (this: BoardWorld, title: string) {
...
Then(
  'the card has description {string}',
  function (this: BoardWorld, description: string) {
...
Then(
  'the stored card still has title {string}',
  async function (this: BoardWorld, title: string) {
